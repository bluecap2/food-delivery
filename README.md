...
비기능적 요구사항
1. 장애격리
    1. 메일함 장애가 나도 발송한 메세지가 사라지지 않아야 한다. 손편지는 중간에 없어질 위험이 있기 때문에 이를 충분히 커버할 수 있도록 보낸 메세지는 절대 유실되지 않아야 한다.
1. 성능
...
비기능적 요구사항
1. 장애격리
    1. 메일함 장애가 나도 발송한 메세지가 사라지지 않아야 한다. 손편지는 중간에 없어질 위험이 있기 때문에 이를 충분히 커버할 수 있도록 보낸 메세지는 절대 유실되지 않아야 한다.(ok)
1. 성능
